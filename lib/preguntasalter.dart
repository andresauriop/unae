...
class pantallaPreguntasAlter extends StatefulWidget {
  ...
  @override
  _pantallaPreguntasAlterState createState() => _pantallaPreguntasAlterState();
}

class _pantallaPreguntasAlterState extends State<pantallaPreguntasAlter> {
  /*void _show() {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title:  Text(widget.par_nombre_completo + "(b)"),
                    ...
                    child: Card(
                      ...
                      child: ListTile(
                        onTap: () async {
                          ...
                          player.play(AssetSource('audio/prueba.mp3'));
                        },
                        title: RichText(
